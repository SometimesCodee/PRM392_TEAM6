...
public class WithdrawSuccessActivity extends AppCompatActivity {
    ...
    private void setupData() {
        // Lấy số tiền rút từ Intent
        String withdrawAmount = getIntent().getStringExtra("withdraw_amount");
        
        // Format số tiền rút
        NumberFormat numberFormat = NumberFormat.getInstance(new Locale("vi", "VN"));
        tvAmount.setText("-" + numberFormat.format(Float.parseFloat(withdrawAmount)) + "đ");
    ...
    private void setupClickListeners() {
        btnContinue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WithdrawSuccessActivity.this, RechargeWithdrawActivity.class);
        ...
        btnBackHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(WithdrawSuccessActivity.this, MainActivity.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                startActivity(intent);
                finish();
            }
